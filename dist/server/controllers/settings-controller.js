...
var pluginId_1 = require("../../common/pluginId");
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, strapi
                                .store({ type: 'plugin', name: pluginId_1["default"], key: 'settings' })
                                .get()];
                        case 1:
                            ...
                            if (savedSettings !== null) {
                                ...
                                ctx.send(settings_1.defaultSettings);
                            }
                            return [2 /*return*/];
                    }
                });
